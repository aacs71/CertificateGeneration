...
{
    public interface IServerCertificateCreateViewForm : ICertificateCreateView
    {
    ...
    public class ServerCertificateCreateFormPresenter : CertificateCreatePresenter<IServerCertificateCreateViewForm>
    {
        public override void OnViewReady()
        {
            ...
            View.DefaultKeyUsage = Constants.DefaultServerKeyUsage;
            View.AvailablePurpose = KeyPurposeUtils.All;
            View.DefaultPurpose = Constants.DefaultServerExtendUsages;
        }
