namespace CertificateManager.Views
{
    partial class SubCACreateForm
    {
        ...
        private void InitializeComponent()
        {
			...
			this.label4.Text = "Ex: um nome ou um DN (ex: CN=AMinha CA,O=A minha companhia, C=PT)";
			// 
			// label3
			// 
			...
			// txtUriOcsp
			// 
			this.txtUriOcsp.Location = new System.Drawing.Point(13, 117);
			this.txtUriOcsp.Name = "txtUriOcsp";
			this.txtUriOcsp.Size = new System.Drawing.Size(383, 20);
			this.txtUriOcsp.TabIndex = 5;
			// 
			// label7
			// 
			...
			// txtCrlUri
			// 
			this.txtCrlUri.Location = new System.Drawing.Point(13, 74);
			this.txtCrlUri.Name = "txtCrlUri";
			this.txtCrlUri.Size = new System.Drawing.Size(383, 20);
			this.txtCrlUri.TabIndex = 3;
			// 
			// groupBox2
			// 
			...
			// txtCaUri
			// 
			this.txtCaUri.Location = new System.Drawing.Point(13, 33);
			this.txtCaUri.Name = "txtCaUri";
			this.txtCaUri.Size = new System.Drawing.Size(383, 20);
			this.txtCaUri.TabIndex = 1;
			// 
			// label5
			// 
			...
			this.Name = "SubCACreateForm";
			this.ShowIcon = false;
			this.ShowInTaskbar = false;
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "Geração Sub CA";
