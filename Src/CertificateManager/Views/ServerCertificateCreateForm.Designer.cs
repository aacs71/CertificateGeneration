...
{
    partial class ServerCertificateCreateForm
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
			...
			this.label13.Text = "Ex: www.url.com, url.com, etc (um por linha)";
			// 
			// txtAlternateNames
			// 
			...
			this.label4.Text = "Ex: um nome ou um DN (ex: CN=OMeu Cert,O=A minha companhia, C=PT)";
			// 
			// label3
			// 
			...
			this.btnUrlGenerationHelp_1.TabIndex = 12;
			...
			this.btnUrlGenerationHelp_2.TabIndex = 13;
			...
			this.btnUrlGenerationHelp_3.TabIndex = 14;
			...
			this.Name = "ServerCertificateCreateForm";
			this.ShowIcon = false;
			this.ShowInTaskbar = false;
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "Geração certificado servidor";
