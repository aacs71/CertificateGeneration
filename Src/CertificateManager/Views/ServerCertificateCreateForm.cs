...
{
    public partial class ServerCertificateCreateForm : Form, IServerCertificateCreateViewForm
    {
        private readonly ServerCertificateCreateFormPresenter _presenter;

        public ServerCertificateCreateForm()
        {
            InitializeComponent();
        }

        public ServerCertificateCreateForm(ServerCertificateCreateFormPresenter presenter)
            : this()
        {
