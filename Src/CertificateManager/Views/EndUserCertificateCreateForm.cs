...
{
    public partial class EndUserCertificateCreateForm : Form, IEndUserCertificateCreateFormPresenter
    {
        private readonly EndUserCertificateCreateFormPresenter _presenter;

        public EndUserCertificateCreateForm()
        {
            InitializeComponent();
        }

        public EndUserCertificateCreateForm(EndUserCertificateCreateFormPresenter presenter)
            : this()
        {
        ...
        {
            get { return txtAlternateNames.Lines; }
        }
